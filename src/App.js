	...
	return (
		<div className="App">
			...
			<Navbar bg="light" variant="light" sticky="top">
				<Navbar.Brand href="/" className="textlogo">
					<strong>MENU</strong>
				</Navbar.Brand>
				...
				<Navbar.Collapse id="basic-navbar-nav">
					...
					<Nav className="ml-auto">
						<Link to="/react">
							<img src={logo} width="40px" height="40px" alt="React Logo" />
						</Link>
						<Link to="/github">
			...
			<ProgressBar position="bottom" color="black" />
			...
			<Switch>
				...
				<Route path="/projects/site">
					{' '}
					<SitePage />{' '}
				</Route>
				<Route path="/projects/slackbot">
					{' '}
					<SlackBotPage />
				</Route>
				...
				<Route
					path="/github"
					component={() => {
						window.location.href = 'https://github.com/zazu7765';
						return null;
					}}
				/>
				<Route path="/">
...
function HomePage() {
	return (
		<Jumbotron>
			...
			<p>This is where I catalogue all my current and past projects, as well as write my own content!</p>
			<p>
				<Link to="/about" className="whitelink">
					<Button variant="primary">About me</Button>
				</Link>
				<div className="divider" />
				<Link to="/projects" className="whitelink">
...
function ProjectsPage() {
	return Array(50).fill(lorem).map((item, index) => <p key={index}>{item}</p>);
}
/*Static Site Page */
function SitePage() {
